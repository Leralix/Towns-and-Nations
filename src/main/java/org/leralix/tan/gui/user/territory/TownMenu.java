...
public class TownMenu extends TerritoryMenu {
    ...
    public TownMenu(Player player, TownData townData) {
        super(player, Lang.HEADER_TOWN_MENU.get(PlayerDataStorage.getInstance().getSync(player).getLang(), PlayerDataStorage.getInstance().getSync(player).getTownSync().getName()), townData);
