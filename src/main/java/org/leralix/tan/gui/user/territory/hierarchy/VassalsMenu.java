        ...
        for (TerritoryData vassal : territoryData.getVassals()) {
            ...
            GuiItem vassalButton = iconManager.get(vassal.getIcon())
                    ...
                    .setAction(action -> {
                        ...
                        if (vassal.isCapital()) {
                            player.sendMessage(TanChatUtils.getTANString() + Lang.CANT_KICK_REGIONAL_CAPITAL.get(tanPlayer, vassal.getName()));
                            return;
                        }
                        PlayerGUI.openConfirmMenu(
                                ...
                                "",
                                confirmAction -> {
                                    territoryData.broadcastMessageWithSound(Lang.GUI_REGION_KICK_TOWN_BROADCAST.get(tanPlayer, vassal.getName()), BAD);
