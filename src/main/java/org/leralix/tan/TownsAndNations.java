...
public final class TownsAndNations extends JavaPlugin {
     ...
     */
    private static final PluginVersion CURRENT_VERSION = new PluginVersion(0,11,9);
    private static final PluginVersion MINIMUM_SUPPORTING_DYNMAP = new PluginVersion(0,9,0);
