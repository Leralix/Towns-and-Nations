...
public class RentingPropertyTransaction extends AbstractTransaction {
    ...
    public RentingPropertyTransaction(
            String territoryID,
            String propertyID,
            String sellerID,
            String buyerID,
    ...
    public GuiItem getIcon(IconManager iconManager, Player player, LangType langType) {
        ...
        return iconManager.get(IconKey.PROPERTY_RENT_TRANSACTION)
                .setName(Lang.RENT_PROPERTY_TRANSACTION.get(langType))
                .setDescription(
