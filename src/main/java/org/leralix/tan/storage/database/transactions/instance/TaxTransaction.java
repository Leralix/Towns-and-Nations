...
public class TaxTransaction extends AbstractTransaction {
    ...
    public TaxTransaction(TerritoryData territoryData, Player player, double amount){
        this.playerID = territoryData.getID();
        this.territoryID = player.getUniqueId().toString();
        this.amount = amount;
    }

    public TaxTransaction(LocalDateTime localDate, String playerID, String territoryID, double amount){
        super(localDate);
    ...
    public String getInsertSQL() {
        return "INSERT INTO transaction_taxes (timestamp, player_id, territory_id, amount) VALUES (?, ?, ?, ?)";
    }
