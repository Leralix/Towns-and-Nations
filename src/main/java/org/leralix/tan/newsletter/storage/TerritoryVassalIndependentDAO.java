...
public class TerritoryVassalIndependentDAO extends NewsletterSubDAO<TerritoryVassalForcedNews> {


    public TerritoryVassalIndependentDAO(Connection connection) {
        super(connection);
    }
