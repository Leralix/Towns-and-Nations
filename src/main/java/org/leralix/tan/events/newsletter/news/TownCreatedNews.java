...
public class TownCreatedNews extends Newsletter {
    ...
    public GuiItem createGuiItem(Player player, LangType lang, Consumer<Player> onClick) {
        ...
        ItemStack itemStack = HeadUtils.makeSkullB64(
                Lang.TOWN_CREATED_NEWSLETTER_TITLE.get(lang), "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNjNkMDJjZGMwNzViYjFjYzVmNmZlM2M3NzExYWU0OTc3ZTM4YjkxMGQ1MGVkNjAyM2RmNzM5MTNlNWU3ZmNmZiJ9fX0=",
                Lang.NEWSLETTER_DATE.get(lang, DateUtil.getRelativeTimeDescription(lang, getDate())),
                Lang.TOWN_CREATED_NEWSLETTER.get(lang, tanPlayer.getNameStored(), townData.getBaseColoredName()),
