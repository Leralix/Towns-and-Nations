...
public class AttackWonByDefenderNewsletter extends Newsletter {
    ...
    public AttackWonByDefenderNewsletter(TanTerritory defendingTerritoryID, TanTerritory attackingTerritoryID) {
        super();
        this.defendingTerritoryID = defendingTerritoryID.getID();
        this.attackingTerritoryID = attackingTerritoryID.getID();
    }

    public AttackWonByDefenderNewsletter(UUID id, long date, String attackingTerritoryID, String defendingTerritoryID) {
        super(id, date);
    ...
    public GuiItem createGuiItem(Player player, LangType lang, Consumer<Player> onClick) {
        ...
        ItemStack icon = HeadUtils.createCustomItemStack(Material.IRON_SWORD,
                ...
                Lang.ATTACK_WON_BY_DEFENDER.get(lang, attackingTerritory.getBaseColoredName(), defendingTerritory.getBaseColoredName(), defendingTerritory.getBaseColoredName()),
    ...
    public void broadcast(Player player) {
        ...
        TanChatUtils.message(player, Lang.ATTACK_WON_BY_ATTACKER.get(player, attackingTerritory.getBaseColoredName(), defendingTerritory.getBaseColoredName(), defendingTerritory.getBaseColoredName()), SoundEnum.MINOR_GOOD);
    }
