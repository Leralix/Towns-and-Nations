...
public class HeadUtils {
    ...
    public static ItemStack getCustomLoreItem(Material itemMaterial, String itemName){
        return getCustomLoreItem(itemMaterial,itemName,(List<String>)null);
    }

    public static ItemStack getCustomLoreItem(Material itemMaterial, String itemName, String... loreLines){
        List<String> lore = Arrays.asList(loreLines);
        return getCustomLoreItem(itemMaterial,itemName, lore);
    }
    public static ItemStack getCustomLoreItem(Material itemMaterial, String itemName, List<String> lore, String... loreLines){
        List<String> lore2 = Arrays.asList(loreLines);
        lore.addAll(lore2);
        return getCustomLoreItem(itemMaterial,itemName, lore2);
    }
    public static ItemStack getCustomLoreItem(Material itemMaterial, String itemName, List<String> lore){
