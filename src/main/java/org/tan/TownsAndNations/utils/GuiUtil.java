...
public class GuiUtil {
    ...
    public static GuiItem makeUpgradeGuiItem(Player player, TownUpgrade townUpgrade, TownData townData){
        ...
        HeadUtils.setLore(upgradeItemStack,
                Lang.GUI_TOWN_LEVEL_UP_DESC1.get(townLevel + "/" + townUpgrade.getMaxLevel()),
                Lang.GUI_TOWN_LEVEL_UP_DESC2.get(townData.getTownLevel().getTownLevel()+1, townUpgrade.getCost(townLevel))
        );
