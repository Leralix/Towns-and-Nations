...
class RessourceRequirementTest extends BasicTest {
    ...
    void testRessourceRequirement_invalid(){
        ...
        RessourceRequirement ressourceRequirement = new RessourceRequirement(new MaterialScope(Material.COBBLESTONE), 10, player);
    ...
    void testRessourceRequirement_valid(){
        ...
        RessourceRequirement ressourceRequirement = new RessourceRequirement(new MaterialScope(Material.COBBLESTONE), quantity, player);
    ...
    void testRessourceRequirement_customScope_valid(){
        ...
        RessourceRequirement ressourceRequirement = new RessourceRequirement(new AnyLogScope(), quantity, player);
