...
class ChangePropertyRentPriceTest extends BasicTest {
  ...
  protected void setUp() {
    ...
    mockedSerializer
        .when(() -> ItemStackSerializer.serializeItemStack(any(ItemStack.class)))
        .thenAnswer(
            invocation -> {
    ...
    mockedSerializer
        .when(() -> ItemStackSerializer.deserializeItemStack(anyString()))
        .thenAnswer(
            invocation -> {
  ...
  void nominalCase() {
    ...
    ChangePropertyRentPrice changePropertyRentPrice =
        new ChangePropertyRentPrice(propertyData, null);
