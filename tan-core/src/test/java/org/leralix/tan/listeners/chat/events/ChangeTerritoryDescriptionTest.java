...
class ChangeTerritoryDescriptionTest {
  ...
  void nominalCaseRegion() {
    ...
    RegionData regionData =
        RegionDataStorage.getInstance().createNewRegion("nation 1", townData).join();
  ...
  void nominalCaseTerritory() {
    ...
    ChangeTerritoryDescription changeDescription =
        new ChangeTerritoryDescription(territoryData, null);
