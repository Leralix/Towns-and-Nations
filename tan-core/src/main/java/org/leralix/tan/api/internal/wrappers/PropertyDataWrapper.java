...
public class PropertyDataWrapper implements TanProperty {
  ...
  public TanPlayer getOwner() {
    if (propertyData.getOwner()
        instanceof org.leralix.tan.dataclass.property.PlayerOwned playerOwned) {
      org.leralix.tan.dataclass.ITanPlayer tanPlayer =
          org.leralix.tan.storage.stored.PlayerDataStorage.getInstance()
              .getSync(playerOwned.getPlayerID());
      return TanPlayerWrapper.of(tanPlayer);
    }
    return null;
  }
