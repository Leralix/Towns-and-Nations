...
public abstract class TerritoryMenu extends BasicGui {
  ...
  protected GuiItem getBrowseButton() {
    return iconManager
        ...
        .setAction(
            event -> {
              BrowseTerritoryMenu.open(
                  player, territoryData, BrowseScope.ALL, p -> territoryData.openMainMenu(player));
            })
        .asGuiItem(player, langType);
  }
  ...
  protected GuiItem getBuildingButton() {
    return iconManager
        ...
        .setAction(event -> BuildingMenu.open(player, territoryData, this))
        .asGuiItem(player, langType);
  }
}
