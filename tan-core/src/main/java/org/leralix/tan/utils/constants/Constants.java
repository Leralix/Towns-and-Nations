...
import org.leralix.tan.wars.WarTimeSlot;
...
public class Constants {
  ...
  public static void init(FileConfiguration config) {
    ...
    warBoundaryParticle =
        Particle.valueOf(config.getString("warBoundaryParticle", "DRAGON_BREATH").toUpperCase());
    ...
    if (relationsSection != null) {
      for (TownRelation relation : TownRelation.values()) {
        ConfigurationSection relationSection =
            relationsSection.getConfigurationSection(relation.name().toLowerCase());
