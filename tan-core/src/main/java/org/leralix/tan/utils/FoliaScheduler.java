...
/**
 * Utility class to handle Folia scheduler compatibility This class provides methods to schedule
 * tasks in a Folia-compatible way
 */
public class FoliaScheduler {
  ...
  /**
   * Run a task on the global region scheduler Use this for tasks that don't depend on a specific
   * location or entity
   *
  ...
  /**
   * Run a task on the entity's scheduler Use this for tasks that involve a specific entity
   *
   * @param plugin The plugin
  ...
  /**
   * Run a task on a region scheduler Use this for tasks that involve a specific location
   *
   * @param plugin The plugin
