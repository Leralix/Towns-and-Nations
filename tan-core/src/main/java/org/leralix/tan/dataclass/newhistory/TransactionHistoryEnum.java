...
public enum TransactionHistoryEnum {
  ...
  public TransactionHistory createTransactionHistory(
    ...
    return switch (this) {
      ...
      case PROPERTY_RENT_TAX ->
          new PropertyRentTaxHistory(date, territoryDataID, transactionParty, amount);
      case PROPERTY_BUY_TAX ->
          new PropertyBuyTaxTransaction(date, territoryDataID, transactionParty, amount);
    };
  }
}
