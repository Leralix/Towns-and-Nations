...
public class PropertyBuyTaxTransaction extends TransactionHistory {
  ...
  public PropertyBuyTaxTransaction(
      String date, String territoryID, String propertyID, double amount) {
  ...
  public String addLoreLine() {
    ...
    return Lang.PROPERTY_SALE_LINE.get(
        Lang.getServerLang(),
        territoryData.getName(),
        propertyData.getName(),
        StringUtil.getColoredMoney(-getAmount()));
  }
}
