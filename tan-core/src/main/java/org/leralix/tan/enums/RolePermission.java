...
public enum RolePermission {
  ...
  UNCLAIM_CHUNK(
      false, IconKey.GUI_UNCLAIM_CHUNK_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_UNCLAIM_CHUNK),
  UPGRADE_TOWN(
      true, IconKey.GUI_UPGRADE_TOWN_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_UPGRADE_TOWN),
  INVITE_PLAYER(
      true, IconKey.GUI_INVITE_PLAYER_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_INVITE_PLAYER),
  ...
  MANAGE_RANKS(
      false, IconKey.GUI_MANAGE_RANK_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_MODIFY_RANK),
  MANAGE_CLAIM_SETTINGS(
      true,
      IconKey.GUI_MANAGE_CLAIMS_ICON,
  ...
  MANAGE_MOB_SPAWN(
      true,
      IconKey.GUI_MANAGE_MOB_SPAWN_ICON,
      Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_MANAGE_MOB_SPAWN),
  CREATE_PROPERTY(
      false, IconKey.GUI_CREATE_PROPERTY_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_CREATE_PROPERTY),
  MANAGE_PROPERTY(
      false, IconKey.GUI_MANAGE_PROPERTY_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_MANAGE_PROPERTY),
  TOWN_ADMINISTRATOR(
