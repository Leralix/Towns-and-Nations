...
public class DefenderAcceptDemandsBeforeWarInternalEvent extends InternalEvent
    implements AttackCancelledByDefenderEvent {

  private final TerritoryData defendingTerritory;
  private final TerritoryData attackedTerritory;

  public DefenderAcceptDemandsBeforeWarInternalEvent(
      TerritoryData defendingTerritory, TerritoryData attackedTerritory) {
    super();
