...
public class TerritoryIndependentNews extends Newsletter {
  ...
  public TerritoryIndependentNews(
      TanTerritory independentTerritoryID, TanTerritory formerMasterID) {
    super();
  ...
  public TerritoryIndependentNews(
      UUID id, long date, String independentTerritoryID, String formerMasterID) {
    super(id, date);
  ...
  public GuiItem createGuiItem(Player player, LangType lang, Consumer<Player> onClick) {
    ...
    if (leavingTown == null || region == null) return null;
    ...
    ItemStack icon =
        HeadUtils.createCustomItemStack(
            ...
            Lang.TOWN_LEAVE_REGION_NEWSLETTER.get(
                lang, leavingTown.getBaseColoredName(), region.getBaseColoredName()),
  ...
  public boolean shouldShowToPlayer(Player player) {
    TerritoryData leavingTown = TerritoryUtil.getTerritory(formerMasterID);
    if (leavingTown == null) return false;
    TerritoryData region = TerritoryUtil.getTerritory(independentTerritoryID);
  ...
  public void broadcast(Player player) {
    ...
    TanChatUtils.message(
        player,
        Lang.TOWN_LEAVE_REGION_NEWSLETTER.get(
            player, leavingTown.getBaseColoredName(), region.getBaseColoredName()),
