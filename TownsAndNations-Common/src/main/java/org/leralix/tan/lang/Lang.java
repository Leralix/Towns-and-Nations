...
public enum Lang {
    ...
    NEWSLETTER_STRING,
    PLAYER_NO_REGION,
    VALUE_EXCEED_MAXIMUM_ERROR,
    VALUE_CANNOT_BE_NEGATIVE_ERROR,
    PLAYER_NO_TOWN,
    TOWN_NO_REGION,
    PLAYER_NOT_IN_TERRITORY,
    LEADER_CANNOT_QUIT_TOWN,
    TOWN_ALREADY_HAVE_OVERLORD,
    PLAYER_NO_PERMISSION,
    PLAYER_NO_PERMISSION_RANK_DIFFERENCE,
    CANNOT_CAST_COMMAND_DURING_ATTACK,
    CANNOT_CAST_COMMAND_ON_PLAYER_WITH_SPECIFIC_RELATION,
    ...
    CHUNK_BIOME_NOT_ALLOWED,
    MAX_CHUNK_LIMIT_REACHED,
    CHUNK_IN_BUFFER_ZONE,
    CHUNK_NOT_ADJACENT,
    CHUNK_CLAIMED_SUCCESS_UNLIMITED,
    CHUNK_CLAIMED_SUCCESS_LIMITED,
    TOWN_INVITE_COMMAND_DESC,
    PLAYER_NOT_FOUND,
    TOWN_NOT_ENOUGH_LEVEL,
    TERRITORY_NOT_ENOUGH_LEVEL,
    CHAT_SCOPE_TOWN_MESSAGE,
    CHAT_SCOPE_REGION_MESSAGE,
    CHAT_SCOPE_NATION_MESSAGE,
    ...
    CANNOT_REMOVE_RELATION_WAR,
    CURRENT_RELATION_REQUIRES_TRUCE,
    CANNOT_SET_RELATION_TO_NEGATIVE_WHILE_TRUCE,
    ACCEPTED_VASSALISATION_PROPOSAL_ALL,
    NATION_ACCEPTED_VASSALISATION_PROPOSAL_ALL,
    REGION_DIPLOMATIC_INVITATION_RECEIVED_1,
    NATION_DIPLOMATIC_INVITATION_RECEIVED_1,
    TOWN_AUTO_CLAIM_DESC,
    AUTO_CLAIM_ON_FOR,
    AUTO_CLAIM_OFF,
    CLAIM_AREA_NOT_WILDERNESS_CHUNK,
    CLAIM_AREA_TOO_BIG,
    TOWN_CHAT_COMMAND_DESC,
    SEE_BORDER_COMMAND_DESC,
    ENABLE_BORDER_INFO,
    DISABLE_BORDER_INFO,
    CHAT_CHANGED,
    ...
    CHUNK_UNCLAIMED_SUCCESS_UNLIMITED,
    CHUNK_UNCLAIMED_SUCCESS_LIMITED,
    PROPERTY_IN_CHUNK,
    BUILDINGS_OR_CAPITAL_IN_CHUNK,
    CHUNK_OCCUPIED_CANT_UNCLAIM,
    CANNOT_UNCLAIM_BECAUSE_CREATE_ORPHAN,
    MAP_COMMAND_DESC,
    ...
    ADMIN_SUDO_COMMAND,
    ADMIN_NAME_FILTER_DESC,
    ADMIN_NAME_FILTER_RELOADED,
    ADMIN_NAME_FILTER_LIST_EMPTY,
    ADMIN_NAME_FILTER_LIST_HEADER,
    ADMIN_NAME_FILTER_ADD_SUCCESS,
    ADMIN_NAME_FILTER_ADD_FAILED,
    ADMIN_NAME_FILTER_REMOVE_SUCCESS,
    ADMIN_NAME_FILTER_REMOVE_FAILED,
    ADMIN_NAME_FILTER_NOT_AVAILABLE,
    DEBUG_SAVE_ALL_DATA,
    DEBUG_CREATE_BACKUP,
    DEBUG_SKIP_DAY,
    DEBUG_SEND_REPORT,
    ...
    PLAYER_PROPERTY_SIGN_RELOCATED,
    PROPERTY_DELETED,
    SET_SPAWN_COMMAND_DESC,
    OPEN_MINIMAP_COMMAND_DESC,
    DEPOSIT_COMMAND_DESC,
    TRUST_COMMAND_DESC,
    PLAYER_NOW_TRUSTED_IN_TERRITORY,
    UNTRUST_COMMAND_DESC,
    PLAYER_NOW_UNTRUSTED_IN_TERRITORY,
    TELEPORT_COMMAND_DESC,
    SPAWN_SET_SUCCESS,
    SPAWN_COMMAND_DESC,
    SPAWN_TELEPORTED,
    SPAWN_NOT_SET,
    ...
    GUI_GENERIC_LEFT_CLICK_TO_NEXT,
    GUI_GENERIC_RIGHT_CLICK_TO_BACK,
    GUI_GENERIC_CLICK_TO_RENAME,
    GUI_GENERIC_CLICK_TO_SELECT,
    GUI_GENERIC_RIGHT_CLICK_TO_DELETE,
    GUI_GENERIC_RIGHT_CLICK_TO_REMOVE,
    GUI_GENERIC_RIGHT_CLICK_TO_CANCEL,
    GUI_GENERIC_SHIFT_CLICK_TO_TELEPORT,
    GUI_GENERIC_CLICK_TO_SWITCH,
    GUI_GENERIC_CLICK_TO_SHOW,
    GUI_GENERIC_ADD_BUTTON,
    GUI_GENERIC_CLICK_TO_UPGRADE,
    GUI_GENERIC_NEW_BALANCE_MENU,
    ...
    CURRENT_PLAYER_TIME,
    GUI_NATION_ICON,
    GUI_NATION_ICON_DESC1_NATION,
    GUI_NATION_ICON_DESC2_NATION,
    GUI_NATION_ICON_DESC1_NO_NATION,
    GUI_REGION_ICON,
    ...
    GUI_TIMEZONE_BUTTON,
    GUI_TIMEZONE_BUTTON_SERVER_ZONE,
    GUI_TIMEZONE_BUTTON_PLAYER_ZONE,
    GUI_LANGUAGE_BUTTON,
    ...
    GUI_NATION_SETTINGS_ICON_DESC1,
    GUI_ATTACK_ICON,
    ...
    TERRITORY_UPKEEP_LINE_OVEREXTENSION,
    TRIBUTE_RECEIVED_TAX_LINE,
    TRIBUTE_PAID_TAX_LINE,
    GUI_LOWER_SALARY,
    ...
    GUI_TREASURY_CREATE_PROPERTY_TAX,
    GUI_TREASURY_CREATE_PROPERTY_TAX_DESC1,
    ...
    GUI_WARP_BUTTON,
    GUI_WARP_BUTTON_DESC,
    GUI_TREASURY_DONATION,
    WRITE_IN_CHAT_AMOUNT_OF_MONEY_FOR_DONATION,
    GUI_TOWN_TREASURY_DONATION_DESC1,
    GUI_TOWN_TREASURY_RIGHT_CLICK_TO_DONATE,
    GUI_TERRITORY_TREASURY_DONATION_DESC1,
    GUI_TERRITORY_TREASURY_RIGHT_CLICK_TO_DONATE,
    ...
    LEVEL_LOCKED,
    MAX_LEVEL_REACHED,
    LEVEL_LOCKED_WITH_LEVEL,
    LEVEL_UNLOCKED_WITH_LEVEL,
    GUI_TOWN_LEVEL_UP,
    GUI_TERRITORY_LEVEL_UP,
    ...
    ANY_WOOD_SCOPE_NAME,
    ANY_LOG_SCOPE_NAME,
    ANY_PLANK_SCOPE_NAME,
    ANY_STONE_SCOPE_NAME,
    REQUIREMENT_RANK_PERMISSION_NEGATIVE,
    REQUIREMENT_RANK_PERMISSION_POSITIVE,
    REQUIREMENT_RANK_LEVEL_NEGATIVE,
    REQUIREMENT_RANK_LEVEL_POSITIVE,
    REQUIREMENT_TERRITORY_LEADER_NEGATIVE,
    REQUIREMENT_TERRITORY_LEADER_POSITIVE,
    REQUIREMENT_COST_NEGATIVE,
    REQUIREMENT_COST_POSITIVE,
    REQUIREMENT_MAIN_LEVEL_NEGATIVE,
    REQUIREMENT_MAIN_LEVEL_POSITIVE,
    REQUIREMENT_UPGRADE_LEVEL_NEGATIVE,
    REQUIREMENT_UPGRADE_LEVEL_POSITIVE,
    REQUIREMENT_RESOURCES_NEGATIVE,
    REQUIREMENT_RESOURCES_POSITIVE,
    REQUIREMENT_UPGRADE_NEGATIVE,
    REQUIREMENT_UPGRADE_POSITIVE,
    GUI_TOWN_LEVEL_UP_UNI_REQ_NOT_MET,
    UPGRADE_DESCRIPTION,
    UPGRADE_CURRENT_LEVEL,
    UPGRADE_LINE_INT,
    UPGRADE_LINE_INT_MAX,
    UPGRADE_LINE_PERCENT,
    UPGRADE_LINE_PERCENT_MAX,
    UPGRADE_LINE_INFINITY_LOCKED,
    UPGRADE_LINE_INFINITY_UNLOCKED,
    UPGRADE_LINE_LOCKED,
    UPGRADE_LINE_LOCKED_UNLOCKED,
    UPGRADE_LINE_UNLOCKED,
    PLAYER_CAP,
    CHUNK_CAP,
    PROPERTY_CAP,
    LANDMARK_CAP,
    ...
    GUI_NATION_SETTINGS_TRANSFER_OWNERSHIP,
    GUI_NATION_SETTINGS_TRANSFER_OWNERSHIP_DESC1,
    GUI_NATION_SETTINGS_TRANSFER_OWNERSHIP_DESC2,
    ...
    GUI_TERRITORY_RELATION_HOSTILE,
    GUI_TERRITORY_RELATION_HOSTILE_DESC1,
    GUI_TERRITORY_RELATION_EMBARGO,
    GUI_TERRITORY_RELATION_EMBARGO_DESC1,
    GUI_TERRITORY_RELATION_NAP,
    GUI_TERRITORY_RELATION_NAP_DESC1,
    GUI_TERRITORY_RELATION_ALLIANCE,
    GUI_TERRITORY_RELATION_ALLIANCE_DESC1,
    GUI_RELATION_TRUCE,
    GUI_RELATION_ENABLE_PVP,
    GUI_RELATION_DISABLE_PVP,
    GUI_RELATION_ENABLE_PROPERTY,
    GUI_RELATION_DISABLE_PROPERTY,
    GUI_RELATION_BLOCK_ENTRY,
    GUI_RELATION_DISABLE_COMMANDS,
    GUI_RELATION_ENABLE_WAR,
    GUI_TOWN_RELATION_DIPLOMACY_PROPOSAL,
    GUI_TOWN_RELATION_DIPLOMACY_PROPOSAL_DESC1,
    GUI_TOWN_RELATION_DIPLOMACY_PROPOSAL_DESC2,
    GUI_TERRITORY_RELATION_DIPLOMACY_PROPOSAL,
    GUI_TERRITORY_RELATION_DIPLOMACY_PROPOSAL_DESC1,
    GUI_TERRITORY_RELATION_DIPLOMACY_PROPOSAL_DESC2,
    GUI_TOWN_RELATION_ADD_TOWN,
    GUI_TOWN_RELATION_REMOVE_TOWN,
    GUI_TERRITORY_RELATION_ADD_TERRITORY,
    GUI_TERRITORY_RELATION_REMOVE_TERRITORY,
    ...
    ENABLE_PISTON_INTERACTON_SETTING,
    ENABLE_MOB_GRIEF_SETTING,
    ENABLE_VILLAGER_GRIEF_SETTING,
    ENABLE_PASSIVE_MOB_GRIEF_SETTING,
    ENABLE_HOSTILE_MOB_GRIEF_SETTING,
    ALLOW_UNAUTHORIZED_PLAYER_MOUNTS_SETTING,
    GUI_TOWN_CLAIM_SETTINGS_DESC1,
    GUI_TOWN_CLAIM_SETTINGS_DESC_ADDITIONAL_PLAYERS,
    GUI_TOWN_CLAIM_SETTINGS_DESC_ADDITIONAL_RANKS,
    GUI_TOWN_CLAIM_SETTINGS_LOCKED,
    GUI_TOWN_CHUNK_PLAYER,
    GUI_TERRITORY_CHUNK_PLAYER,
    CHUNK_GENERAL_SETTINGS,
    GUI_TOWN_CHUNK_MOB,
    GUI_TERRITORY_CHUNK_MOB,
    ...
    GUI_SHIFT_RIGHT_CLICK_TO_ADD_SPECIFIC_RANK,
    GUI_BUILDING_MENU,
    ...
    CREATE_FORT_DESC3,
    CREATE_FORT_DESC4,
    CREATE_FORT_DESC_ALLOW_TELEPORTATION,
    CREATE_FORT_DESC_ALLOW_TELEPORTATION_OUTSIDE_WARS,
    GUI_TOWN_ATTACK_TOWN_DESC1,
    DECLARE_WAR_CONFIRM_MESSAGE,
    DECLARE_WAR_NUMBER_OF_ALLIES,
    CHUNK_CONQUER_INFO,
    CHUNK_CONQUER_DESC,
    CHUNK_CONQUER_NO_CURRENT,
    DECLARE_WAR_BUTTON,
    OPEN_ATTACK_BUTTON,
    WAR_GOAL_LIST_BUTTON,
    WAR_GOAL_LIST_BUTTON_DESC1,
    WAR_GOAL_LIST_BUTTON_LIST,
    WAR_GOAL_LIST_BUTTON_LIST_NO_WAR_GOAL_SET,
    WAR_CREATE_ATTACK,
    WAR_ENEMY_GOAL_LIST,
    WAR_ENEMY_GOAL_LIST_DESC1,
    WAR_SURRENDER,
    WAR_SURRENDER_DESC1,
    WAR_SURRENDER_DESC2,
    SURRENDER_PROGRESS_DESCRIPTION,
    SURRENDER_PROGRESS_CAPITAL_OCCUPIED,
    SURRENDER_PROGRESS_CAPITAL_OWNED,
    GUI_ADD_WAR_GOAL,
    ...
    GUI_TOWN_MEMBERS_ROLE_SET_DEFAULT,
    ...
    GUI_ADD_PLAYER_WITH_PERMISSION_ALREADY_HAS_PERMISSION_DESCRIPTION,
    GUI_ADD_PLAYER_WITH_PERMISSION_DESCRIPTION,
    GUI_ADD_RANK_CURRENT_STATUS,
    GUI_ADD_RANK_ALLOWED_PERMISSION,
    GUI_ADD_RANK_NEUTRAL_PERMISSION,
    ...
    GUI_NATION_SETTINGS_TRANSFER_OWNERSHIP_TO_SPECIFIC_PLAYER_DESC1,
    GUI_NATION_SETTINGS_TRANSFER_OWNERSHIP_TO_SPECIFIC_PLAYER_DESC2,
    GUI_NATION_SETTINGS_TRANSFER_OWNERSHIP_TO_SPECIFIC_PLAYER_SUCCESS,
    GUI_REGION_SETTINGS_REGION_CHANGE_LEADER_BROADCAST,
    GUI_REGION_SETTINGS_REGION_CHANGE_CAPITAL_BROADCAST,
    GUI_NATION_SETTINGS_NATION_CHANGE_LEADER_BROADCAST,
    GUI_SETTINGS_CHANGE_TOWN_MESSAGE,
    GUI_SETTINGS_CHANGE_TOWN_MESSAGE_DESC1,
    ENTER_NEW_VALUE,
    ...
    GUI_SETTINGS_CHANGE_TERRITORY_NAME_DESC1,
    GUI_SETTINGS_CHANGE_TERRITORY_NAME_DESC3,
    GUI_TOWN_SETTINGS_QUIT_REGION,
    GUI_REGION_SETTINGS_LEAVE_NATION,
    GUI_REGION_SETTINGS_LEAVE_NATION_DESC1,
    GUI_REGION_SETTINGS_LEAVE_NATION_DESC2,
    GUI_TOWN_SETTINGS_CHANGE_CHUNK_COLOR,
    GUI_TOWN_SETTINGS_CHANGE_CHUNK_COLOR_DESC1,
    GUI_TOWN_SETTINGS_CHANGE_CHUNK_COLOR_DESC2,
    GUI_TERRITORY_SETTINGS_AUTHORIZED_TELEPORTATION,
    GUI_TERRITORY_SETTINGS_AUTHORIZED_TELEPORTATION_DESC,
    GUI_TOWN_SETTINGS_CHANGE_CAPITAL,
    ...
    GUI_CAPITAL_CHUNK_ACTUAL_POSITION,
    CANNOT_MOVE_CAPITAL_WHILE_AT_WAR,
    GUI_NO_CAPITAL_CHUNK,
    HELP_US_TRANSLATE,
    PERCENT_COMPLETED,
    ...
    ADMIN_GUI_DELETE_TERRITORY,
    ADMIN_GUI_DELETE_TERRITORY_DESC1,
    ADMIN_GUI_TOWN_PLAYER_TOWN,
    ADMIN_GUI_PLAYER_NO_TOWN,
    ...
    ADMIN_ADD_TERRITORY_BALANCE,
    ADMIN_GUI_LANDMARK_ICON,
    ADMIN_GUI_LANDMARK_DESC1,
    ADMIN_GUI_WAR_ICON,
    ADMIN_ATTACKS_NEED_APPROVALS,
    ADMIN_FORCE_SURRENDER_ATTACK_SIDE,
    ADMIN_FORCE_SURRENDER_DEFENSIVE_SIDE,
    ADMIN_GUI_MANAGE_ATTACKS,
    ADMIN_GUI_CREATE_LANDMARK,
    GUI_LANDMARK_LEFT_CLICK_TO_CLAIM,
    GUI_LANDMARK_CLAIM_COST,
    GUI_LANDMARK_TOWN_FULL,
    GUI_LANDMARK_NOT_ENCIRCLED,
    GUI_LANDMARK_NOT_ENOUGH_MONEY,
    ...
    GUI_TOWN_MEMBERS_ROLE_PRIORITY_MANAGE_WAR,
    ...
    GUI_TOWN_MEMBERS_ROLE_PRIORITY_MANAGE_LANDMARK,
    GUI_TOWN_MEMBERS_ROLE_PRIORITY_COLLECT_LANDMARK,
    ...
    WILDERNESS,
    PLAYER_ENTER_TERRITORY_CHUNK,
    PLAYER_ENTER_LANDMARK_CHUNK,
    PLAYER_CANNOT_ENTER_CHUNK_WITH_RELATION,
    ...
    GUI_NATION_CREATE,
    GUI_NATION_CREATE_DESC1,
    GUI_NATION_CREATE_DESC2,
    GUI_NATION_BROWSE,
    GUI_NATION_BROWSE_DESC1,
    GUI_NATION_BROWSE_DESC2,
    WRITE_IN_CHAT_NEW_NATION_NAME,
    ...
    GUI_NATION_INFO_DESC0,
    GUI_NATION_INFO_DESC1,
    GUI_NATION_INFO_DESC2,
    GUI_NATION_INFO_DESC3,
    GUI_NATION_INFO_DESC5,
    GUI_NATION_INFO_DESC6_NO_OVERLORD,
    GUI_REGION_TOWN_LIST,
    GUI_REGION_TOWN_LIST_DESC1,
    GUI_NATION_REGION_LIST,
    GUI_NATION_REGION_LIST_DESC1,
    GUI_HIERARCHY_MENU,
    ...
    GUI_NATION_CHANGE_CAPITAL,
    GUI_NATION_CHANGE_CAPITAL_DESC1,
    GUI_NATION_CHANGE_CAPITAL_DESC2,
    GUI_NATION_DELETE,
    GUI_NATION_DELETE_DESC1,
    GUI_NATION_DELETE_DESC2,
    GUI_NEED_TO_BE_LEADER_OF_REGION,
    GUI_INVITE_TOWN_TO_REGION,
    GUI_REGION_INVITE_TOWN_DESC1,
    GUI_INVITE_REGION_TO_NATION,
    GUI_NATION_INVITE_REGION_DESC1,
    ...
    LANDMARK_PRODUCTION_NAME,
    SPECIFIC_LANDMARK_NAME,
    ...
    TERRITORY_DIPLOMATIC_INVITATION_NO_LEADER,
    PROPERTY_OVERLAPING,
    ...
    CANNOT_DELETE_TERRITORY_IF_AT_WAR,
    ...
    LANDMARK_NOT_FOUND,
    CANNOT_TELEPORT_TO_FORT_WHILE_AT_WAR,
    FORT_ACTION_BAR_INFO,
    INVALID_VALUE,
    INVALID_ID,
    INVALID_NAME,
    INVALID_TERRITORY,
    ...
    HEADER_TOWN_MEMBERS,
    HEADER_REGION_MEMBERS,
    HEADER_NATION_MEMBERS,
    ...
    HEADER_HISTORY,
    HEADER_TOWN_UPGRADE,
    HEADER_TERRITORY_UPGRADE,
    HEADER_SETTINGS,
    HEADER_CHANGE_OWNERSHIP,
    HEADER_CHANGE_NATION_CAPITAL,
    HEADER_RELATIONS,
    ...
    WAR_TIME_SLOT_DAYS_ENABLED_TITLE,
    WAR_TIME_SLOT_DAYS_ENABLED_ITERATOR,
    GUI_CONFIRM_ATTACK,
    OVERLORD_GUI,
    ...
    CANNOT_DECLARE_INDEPENDENCE_BECAUSE_NATION_CAPITAL,
    ...
    ATTACK_ICON_DESC_4,
    ATTACK_ICON_DESC_8,
    ATTACK_ICON_NOT_YET_STARTED,
    ATTACK_ICON_NOT_YET_STARTED_START_DATE,
    ATTACK_ICON_NOT_YET_STARTED_DURATION_DATE,
    ATTACK_ICON_CANCELLED,
    ATTACK_ICON_CANCELLED_DATE,
    ATTACK_ICON_FINISHED,
    ATTACK_ICON_FINISHED_DATE,
    ATTACK_ICON_FINISHED_NB_DEATH_ATTACKERS,
    ATTACK_ICON_FINISHED_NB_DEATH_DEFENDERS,
    ATTACK_ICON_FINISHED_NB_CHUNK_CAPTURED,
    ATTACK_ICON_FINISHED_NB_FORTS_CAPTURED,
    ...
    REGION_BROADCAST_REGION_LEFT_NATION,
    NATION_BROADCAST_REGION_LEFT_NATION,
    GUI_CONFIRM_CHANGE_TOWN_LEADER,
    GUI_CONFIRM_CHANGE_NATION_LEADER,
    CONFIRM_PLAYER_KICKED,
    GUI_CONFIRM_DELETE_REGION,
    GUI_CONFIRM_CHANGE_LEADER,
    GUI_CONFIRM_DELETE_NATION,
    GUI_CONFIRM_CHANGE_NATION_CAPITAL,
    CONQUER_WAR_GOAL,
    CONQUER_WAR_GOAL_DESC,
    CONQUER_WAR_GOAL_DESC1,
    GUI_ONLY_ONE_WAR_GOAL_TYPE,
    GUI_CONQUER_CHUNK_CURRENT_DESC,

    TRIBUTE_WAR_GOAL,
    TRIBUTE_WAR_GOAL_DESC,
    TRIBUTE_WAR_GOAL_DESC1,

    CAPTURE_LANDMARK_WAR_GOAL,
    CAPTURE_LANDMARK_WAR_GOAL_DESC,
    GUI_CAPTURE_LANDMARK_CURRENT_DESC,

    CAPTURE_FORT_WAR_GOAL,
    CAPTURE_FORT_WAR_GOAL_DESC,
    CAPTURE_FORT_WAR_GOAL_DESC1,

    GUI_WARGOAL_CAPTURE_LANDMARK_CANNOT_BE_USED,
    SUBJUGATE_WAR_GOAL,
    SUBJUGATE_WAR_GOAL_DESC,
    SUBJUGATE_WAR_GOAL_DESC1,
    ...
    LIBERATE_SUBJECT_WAR_GOAL_DESC1,
    GUI_WARGOAL_LIBERATE_CANNOT_BE_USED,
    GUI_WARGOAL_LIBERATE_WAR_GOAL_RESULT,
    GUI_WARGOAL_OUTSIDE_AUTHORIZED_SLOTS,
    GUI_ATTACK_ALREADY_PLANNED_IN_TIME,
    ALL_ATTACK_SCOPE,
    UNFINISHED_ATTACK_SCOPE,
    GUI_RENAME_WAR,
    TERRITORY_CANNOT_LEAVE_WAR,
    GUI_TERRITORY_SETTINGS_SET_BANNER,
    GUI_SETTINGS_SET_FLAG_ACTION,
    TERRITORY_NO_LONGER_INVOLVED_IN_WAR_MESSAGE,
    GUI_QUIT_WAR_DESC1,
    DEFENSIVE_SIDE_HAS_SURRENDER,
    BROWSE_SELECT,
    BROWSE_ITERATOR_SELECTED_OPTION,
    BROWSE_ITERATOR_UNSELECTED_OPTION,
    BROWSE_ALL_NAME,
    BROWSE_TOWNS_NAME,
    BROWSE_REGIONS_NAME,
    BROWSE_NATIONS_NAME,
    ALL_TRANSACTION_SCOPE,
    PAYMENT_TRANSACTION_SCOPE,
    DONATION_TRANSACTION_SCOPE,
    RETRIEVE_TRANSACTION_SCOPE,
    TAXES_TRANSACTION_SCOPE,
    TERRITORY_TAXES_TRANSACTION_SCOPE,
    TERRITORY_CHUNK_UPKEEP_TRANSACTION_SCOPE,
    SALARY_TRANSACTION_SCOPE,
    CREATE_PROPERTY_TRANSACTION_SCOPE,
    SELL_PROPERTY_TRANSACTION_SCOPE,
    RENT_PROPERTY_TRANSACTION_SCOPE,
    CHANGE_TERRITORY_NAME_TRANSACTION_SCOPE,
    UPGRADE_TRANSACTION_SCOPE,
    DONATION_TRANSACTION_NAME,
    PAYMENT_TRANSACTION_NAME,
    PLAYER_TAX_TRANSACTION,
    RETRIEVE_TRANSACTION_NAME,
    SALARY_TRANSACTION_NAME,
    TERRITORY_TAX_TRANSACTION,
    UPGRADE_TRANSACTION,
    RENT_PROPERTY_TRANSACTION,
    SELL_PROPERTY_TRANSACTION,
    TRANSACTION_FROM,
    TRANSACTION_TO,
    TRANSACTION_PROPERTY,
    TRANSACTION_AMOUNT,
    TRANSACTION_TAX,
    TRANSACTION_FLAT_TAX,
    TRANSACTION_UPGRADE,
    TRANSACTION_DAILY,
    TRANSACTION_DAILY_NOT_ENOUGH_MONEY,
    CHUNK_UPKEEP_INFO,
    TRANSACTION_FAILED_NOT_ENOUGH_MONEY,
    TRANSACTION_DATE,
    MAIN_ATTACKER_NAME,
    MAIN_DEFENDER_NAME,
    OTHER_ATTACKER_NAME,
    ...
    NATION_CREATED_NEWSLETTER_TITLE,
    NATION_CREATED_NEWSLETTER,
    NATION_DELETED_NEWSLETTER_TITLE,
    NATION_DELETED_NEWSLETTER,
    TOWN_JOIN_REGION_PROPOSAL_NEWSLETTER,
    ...
    DIPLOMACY_ACCEPT_NEWSLETTER_TITLE,
    DIPLOMACY_ACCEPT_NEWSLETTER,
    FORCED_VASSALAGE_TITLE,
    FORCED_VASSALAGE,
    ATTACK_DECLARED_TITLE,
    ATTACK_DECLARED,
    ATTACK_START_IN_1_MINUTES,
    ATTACK_START_NOW,
    ATTACK_ENDED_TITLE,
    ATTACK_ENDED,
    WAR_DECLARED_TITLE,
    ...
    RELATIVE_TIME_YEAR,
    FORT_OCCUPIED_BY,
    CANNOT_CREATE_FORT_IF_ABOVE_BLOCKED,
    DEFAULT_FORT_NAME,
    RIGHT_CLICK_TO_PLACE_FORT,
    CHANGE_CAPITAL_NOT_OWNED_TOWN_CHUNK,
    CHANGE_CAPITAL_NOT_TOWN_CHUNK,
    WAR_INFO_CHUNK_PROTECTED,
