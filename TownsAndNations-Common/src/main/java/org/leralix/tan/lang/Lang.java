...
public enum Lang {
    ...
    GUI_TERRITORY_CHANGE_OWNERSHIP,
    GUI_TERRITORY_CHANGE_OWNERSHIP_DESC1,
    GUI_TERRITORY_CHANGE_CAPITAL,
    GUI_TERRITORY_CHANGE_CAPITAL_DESC1,
    GUI_REGION_DELETE,
    ...
    RELATIVE_TIME_YEAR,
    FORT_OCCUPIED_BY,
    FORT_ALREADY_PRESENT_ON_CHUNK,
    CANNOT_CREATE_FORT_ON_THIS_BLOCK,
