...
public class TownsAndNations extends JavaPlugin {
     ...
     */
    private static final PluginVersion CURRENT_VERSION = new PluginVersion(1, 0, 4);
    ...
    private void enableEventList(MinimapManager minimapManager) {
        ...
        pluginManager.registerEvents(new PlayerEnterChunkListener(playerDataStorage, claimStorage, minimapManager), this);
