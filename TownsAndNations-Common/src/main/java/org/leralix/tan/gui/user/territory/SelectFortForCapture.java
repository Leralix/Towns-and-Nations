...
public class SelectFortForCapture extends IteratorGUI {
    ...
    public SelectFortForCapture(Player player, Territory territoryData, War war, WarRole warRole, BasicGui returnGui) {
    ...
    private List<GuiItem> getForts() {
        ...
        for(Fort fort : TownsAndNations.getPlugin().getFortStorage().getOwnedFort(enemyTerritory)) {
