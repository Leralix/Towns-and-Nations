...
public class AttackEndedNewsletter extends Newsletter {

    private final String attackingTerritoryID;
    private final String defendingTerritoryID;

    public AttackEndedNewsletter(TanTerritory defendingTerritory, TanTerritory attackingTerritory) {
        super();
        this.defendingTerritoryID = defendingTerritory.getID();
        this.attackingTerritoryID = attackingTerritory.getID();
    }

    public AttackEndedNewsletter(UUID id, long date, String attackingTerritoryID, String defendingTerritoryID) {
        super(id, date);
    ...
    public void broadcast(Player player, ITanPlayer tanPlayer) {
        ...
        TanChatUtils.message(player, Lang.ATTACK_ENDED.get(tanPlayer, attackingTerritory.getColoredName(), defendingTerritory.getColoredName()), SoundEnum.MINOR_GOOD);
    }
}
