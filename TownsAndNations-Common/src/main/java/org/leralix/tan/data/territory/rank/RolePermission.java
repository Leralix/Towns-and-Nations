...
public enum RolePermission {
    ...
    UPGRADE_TOWN(false, IconKey.GUI_UPGRADE_TOWN_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_UPGRADE_TOWN),
    ...
    MANAGE_CLAIM_SETTINGS(false, IconKey.GUI_MANAGE_CLAIMS_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_MANAGE_CLAIM_SETTINGS),
    ...
    MANAGE_MOB_SPAWN(false, IconKey.GUI_MANAGE_MOB_SPAWN_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_MANAGE_MOB_SPAWN),
    ...
    TOWN_ADMINISTRATOR(false, IconKey.GUI_ADMINISTRATOR_ICON, Lang.GUI_TOWN_MEMBERS_ROLE_PRIORITY_TOWN_ADMINISTRATOR),
