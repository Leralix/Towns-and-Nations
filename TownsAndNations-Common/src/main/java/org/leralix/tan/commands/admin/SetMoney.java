...
public class SetMoney extends SubCommand {
    ...
    void setMoney(CommandSender commandSender, String[] args, ITanPlayer target) {
        double amount;
        try {
        ...
        TanChatUtils.message(commandSender, Lang.SET_MONEY_COMMAND_SUCCESS.get(Double.toString(amount), target.getNameStored()));
