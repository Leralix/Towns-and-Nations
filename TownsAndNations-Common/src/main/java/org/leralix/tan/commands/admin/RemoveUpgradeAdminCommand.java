...
public class RemoveUpgradeAdminCommand extends PlayerSubCommand {

    private final PlayerDataStorage playerDataStorage;

    public RemoveUpgradeAdminCommand(PlayerDataStorage playerDataStorage) {
    ...
    public String getDescription() {
        return "Remove an upgrade from the territory at your position";
    }
    ...
    public String getSyntax() {
        return "/tanadmin removeupgrade <upgradeId>";
    }
    ...
    public void perform(Player player, String[] args) {
        ...
        if (!owner.getNewLevel().levelDown(upgrade)) {
